 ...
 * @author User
 */
public class Searcing_Data extends javax.swing.JFrame {

    /**
     * Creates new form Searcing_Data
     */
    public Searcing_Data() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            if (a.isEmpty()){
                ...
                jTextArea1.append("     "+"Name"+"                                     "+"NID S.N"+"                                                "+"Email"+"                           "+"Phone Number"+"                                            "+"Address");
                jTextArea1.append("\n");
                jTextArea1.append("\n");
                ...
                while(null != (st = b.readLine())){
                    ...
                    if(line.contains(take)){
                        ...
                        jTextArea1.append(sval[0]+"                  "+sval[1]+"                         "+sval[2]+"              "+sval[3]+"                             "+sval[4]);
                        jTextArea1.append("\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Searcing_Data.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
