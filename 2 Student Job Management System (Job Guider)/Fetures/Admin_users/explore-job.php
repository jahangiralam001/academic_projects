					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="job-detail-wrapper">
								...
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-padlock"></i> Login as Student to apply</button>';
								}	
								}
														...
														<div class="GridLex-grid-middle">
															...
															<div class="GridLex-col-3_sm-8-xs-8_xss-12 mt-10-xss">
																<div class="job-location">
																	<i class="fa fa-map-marker text-primary"></i> <?php echo $row['city']; ?>
																</div>
															</div>
