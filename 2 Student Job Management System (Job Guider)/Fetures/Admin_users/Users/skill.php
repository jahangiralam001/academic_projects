...
?>
						...
						<!-- <div class="GridLex-col-9_sm-8_xs-12">
                                ...
                                $stmt = $conn->prepare("SELECT * FROM tbl_skill WHERE member_no = '$id' ORDER BY id LIMIT $page1,5");
                                $stmt->execute();
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-2">
                                                ...
                                                <div class="resume-list-btn">
                                                    ...
                                                    <a href="app/drop-skill.php?id=<?php echo $row['id']; ?> & ref=<?php echo "$id"?>" onclick = "return confirm('Are you sure you want to delete this skill ?')" class="btn btn-primary btn-sm btn-inverse">Delete</a>
                                                    ...
                                                    <form action="app/update-skill.php?ref=<?php echo "$id"?>" method="POST" autocomplete="off" enctype="multipart/form-data">
                            ...
                            $total_records = 0;
                                ...
                                $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                                $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                $stmt = $conn->prepare("SELECT * FROM tbl_skill WHERE member_no = '$id' ORDER BY id");
                                $stmt->execute();
                                $result = $stmt->fetchAll();
                            ...
                            ?>
                                ...
                                <div class="modal-body">
                                <form action="app/add-skill.php?ref=<?php echo "$id"?>" method="POST" autocomplete="off" enctype="multipart/form-data">
                                <div class="row gap-20">
                                <div class="col-sm-12 col-md-12">
