...
$stmt = $conn->prepare("UPDATE tbl_referees SET ref_name = :refname, ref_mail = :refmail, ref_title = :reftitle, ref_phone = :refphone, institution = :institution 
                        WHERE id= :refid AND member_no = '$myid'");
...
$stmt->execute();
header("location:../referees.php?ref=$myid & r=7642");					  
