...
<!-- <link href="../css/nassv.css " rel="stylesheet"> -->
			...
			<div class="container">
				...
				<div class="nav-mini-wrapper"> 
					...
					<div class="menu-bar">
						...
						<li><a href="../../Admin/index.php"><span class="text-primary"><?php echo "Admin"; ?></span> <i class="fa fa-caret-down"></i> </a></li>
						...
						<!-- <div class="dropdown-menu">
							...
							<li  class="active">
										...
										<li>
											<a href="../company.php?ref=/"><i class="fa fa-briefcase"></i> Company Overview</a>
										</li>
										<li>
