						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										...
										<address> United City,  <br/> Madani Ave,  <br/>Dhaka 1212</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:xyz@gmail.com">xyz@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:013 546 607 74">013 546 607 74</a>
								</li>
