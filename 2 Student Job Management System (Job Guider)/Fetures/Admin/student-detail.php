			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="employees.php">All Students</a></li>
									...
									<div class="employee-detail-company-overview mt-40 clearfix">
										...
										<div class="row">
											...
											<div class="col-sm-12">
												...
												<p class="text-muted font-italic">Level - <?php echo $row['level']; ?> , <?php echo $row['timeframe']; ?><span class="font600 text-primary"><br><br> <?php  echo $row['institution']; ?></span> <?php echo $row['country']; ?></p>
												<p><a target="_blank" class="btn btn-primary btn-sm mb-5 mb-0-sm" href="view-certificate.php?id=<?php echo $row['id']; ?>">View CV</a></p>
												</li>
												<?php
	                                            }
										...
										<h3>Skills</h3>
                                                ...
                                                $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                                                $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                                $stmt = $conn->prepare("SELECT * FROM tbl_skill WHERE member_no = :empid ORDER BY id");
	                                            $stmt->bindParam(':empid', $empid);
                                                $stmt->execute();
                                                $result = $stmt->fetchAll();
	                                            $rec = count($result);
												...
												<p class="text-muted font-italic">Experience:- <span class="font600 text-primary"> <?php echo $row['experience']; ?> Years</span> </p>
												</li>
												<?php
	                                            }
