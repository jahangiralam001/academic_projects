...
// 	$company_id = $_GET['ref'];           try{
// 		require 'dry_code/db_config.php';
							...
							<div class="col-sm-7 col-md-8">
								...
								<div class="company-detail-wrapper">
									...
									<div class="company-detail-company-overview  mt-0 clearfix">
										...
										<form class="post-form-wrapper" action="app/update-job.php ?ref=<?php echo "$jobid"?>" method="POST" autocomplete="off">
											...
											<?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="experience" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															<option value="" selected >Select</option>
															<option <?php if ($experience == "Fresher") { print ' selected '; } ?> value="Fresher">Fresher</option>
															<option <?php if ($experience == "1 Years") { print ' selected '; } ?> value="1 Years">1 Years</option>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label> <b>Job Responsibilies</b></label>
