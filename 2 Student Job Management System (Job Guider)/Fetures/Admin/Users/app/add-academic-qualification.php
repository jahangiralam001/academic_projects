...
$stmt = $conn->prepare("INSERT INTO tbl_academic_qualification (member_no, country, institution, course, level, timeframe,certificate, sid) VALUES 
(:member, :country, :institution, :course, :level, :timeframe,:certificate, :sid)");
