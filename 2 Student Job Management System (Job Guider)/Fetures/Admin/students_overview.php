			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Students_overview</span></li>
					</ol>
...
<!-- ---------------------------Side-Bar Close------------------------------- -->
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
                                  ...
                                  $stmt = $conn->prepare("SELECT * FROM tbl_users WHERE role = 'employee' ORDER BY first_name LIMIT $page1,10");
                                  $stmt->execute();
                                  ...
                                  foreach($result as $row)
                                  {
									...
									?>
									   <a target="_blank" href="../Admin_users/Users/index.php?ref=<?php echo $row['member_no']; ?>" class="recent-job-item clearfix">
								<div class="GridLex-grid-middle">
									<div class="GridLex-col-6_xs-12">
										<div class="job-position">
										    ...
										    echo '<center><img class="autofit3" alt="image" title="'.$sfname.'" width="180" height="100" src="data:image/jpeg;base64,'.base64_encode($complogo).'"/></center>';	
										    }
										     ?>
											</div>
											<div class="content">
												<h4><?php echo "$sfname $slname"; ?></h4>
												<p><?php echo "$title"; ?></p>
									...
									<div class="GridLex-col-3_xs-4_xss-12">
										...
										<span class="font12 block spacing1 font400 text-center"><?php echo "$clogin"; ?></span>
									</div>
								</div>
							</a>
